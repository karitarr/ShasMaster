...
# requires the things that get the https
require 'json'
require 'rest-client'
require 'net/smtp'
...
def get_movies(min_score=90, availability="in-theaters", certified="true", genres="10")
    ...
    # create a URL for the rotten tomatoes private API
    ...
    #fetch list of movies already seen from file
    log_file = open("/Users/kari_tarr/movies_seen.txt", "r")
    movies_seen = log_file.read

    #write only unseen movies to seen file
